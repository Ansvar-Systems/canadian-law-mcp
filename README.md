...
**Endpoint:** `https://mcp.ansvar.eu/law-canadian-law-mcp/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add canadian-law --transport http https://mcp.ansvar.eu/law-canadian-law-mcp/mcp` |
...
```json
{
  "mcpServers": {
    "canadian-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-canadian-law-mcp/mcp"
    }
  }
}
```
