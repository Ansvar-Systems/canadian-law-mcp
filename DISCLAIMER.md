...
- **Professional Rules**: Law Society of Ontario, Barreau du Québec members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Justice Laws (laws-lois.justice.gc.ca), CanLII)
...
This Tool aggregates data from official Canada legal databases. However:
...
- LexisNexis Quicklaw, Westlaw Canada, CanLII
...
- Canada law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (Justice Laws (laws-lois.justice.gc.ca), CanLII)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Canadian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Canadian-law-mcp/issues
